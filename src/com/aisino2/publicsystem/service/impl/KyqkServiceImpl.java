...
public class KyqkServiceImpl extends BaseService implements IKyqkService {
	...
	/** @param 可疑情况(t_kyqk) 分页查询     行业类别为旅馆业 */
	public Page getListForPageGADlg(Map map, int pageNo,int pageSize,String sort,String desc){
		// TODO: implement
		return kyqkDao.getListForPageGADlg(map,pageNo,pageSize,sort,desc);
