...
public class QyscbcfServiceImpl extends BaseService implements IQyscbcfService {
	...
	private void getConditions(Map map) {
		...
		String selectConditon = "";
			groupBy = "b.ssddsjgdm,b.ssddsjgmc" + ",b.ssdxjgajgdm,b.ssdxjgajgmc" + ",b.gxdwbm,b.gxdwmc"
					+ ",b.qybm,b.qymc" +",b.hylbdm,b.hylb";
			selectConditon = "b.ssddsjgdm dsjgdm,b.ssddsjgmc dsjgmc" + ",b.ssdxjgajgdm fxjdm,b.ssdxjgajgmc fxjmc" + ",b.gxdwbm gxdwdm,b.gxdwmc"
			+ ",b.qybm,b.qymc" +",b.hylbdm,b.hylb";
