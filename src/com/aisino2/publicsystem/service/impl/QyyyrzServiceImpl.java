...
public class QyyyrzServiceImpl extends BaseService implements IQyyyrzService {
	...
	/** 企业营业日志新 公安端查询 标准化公安端*/
	public Page getListForPageQyyyrzcx(Map map, int pageNo,int pageSize,String sort,String desc){
		return qyyyrzDao.getListForPageQyyyrzcx(map,pageNo,pageSize,sort,desc);
	}
