...
public class QysctjServiceImpl extends BaseService implements IQysctjService {
	...
	private void getConditionsxx(Map map) {
		...
		if (csbz) {
			...
			selectConditon = groupBy+", to_char(a.tjrq,'yyyy-mm-dd') tjrqString,'0' as lxdh,'0' as sfdb";
		} else if (gxdwbz) {

			groupBy = "a.dsjgdm,a.dsjgmc" + ",a.fxjdm,a.fxjmc" + ",a.gxdwdm,a.gxdwmc,a.tjrq";
			selectConditon = groupBy + ", to_char(a.tjrq,'yyyy-mm-dd') tjrqString,'' as qybm,'' as qymc,'' as hylbdm,'' as hylb"+",'0' as lxdh,'0' as sfdb";
		} else if (fxjbz) {
			groupBy = "a.dsjgdm,a.dsjgmc" + ",a.fxjdm,a.fxjmc,a.tjrq";
			selectConditon = groupBy + ", to_char(a.tjrq,'yyyy-mm-dd') tjrqString,'' as gxdwdm,'' as gxdwmc"
					+ ",'' as qybm,'' as qymc,'' as hylbdm,'' as hylb"+",'0' as lxdh,'0' as sfdb";
		} else if (dsjgbz) {
			groupBy = "a.dsjgdm,a.dsjgmc ,a.tjrq";
			selectConditon = groupBy + ", to_char(a.tjrq,'yyyy-mm-dd') tjrqString,'' as fxjdm,'' as fxjmc"
					+ ",'' as gxdwdm,'' as gxdwmc" + ",'' as qybm,'' as qymc,'' as hylbdm,'' as hylb"+",'0' as lxdh,'0' as sfdb";
		} else {
			groupBy = "";
			selectConditon = "'' as dsjgdm,'' as dsjgmc,a.tjrq, to_char(a.tjrq,'yyyy-mm-dd') tjrqString"
					+ ",'' as fxjdm,'' as fxjmc" + ",'' as gxdwdm,'' as gxdwmc"
					+ ",'' as qybm,'' as qymc,'' as hylbdm,'' as hylb"+",'0' as lxdh,'0' as sfdb";
		}
		map.put("groupBy", groupBy);
