...
public class QyjbxxDaoImpl extends BaseDao implements IQyjbxxDao {
	 ...
	 * @param qyjbxx(qyid,zjbh)
	 */
	public Qyjbxx isQyjbxxqybmExist(Qyjbxx qyjbxx)
	{
		return (Qyjbxx)queryForObject("isQyjbxxqybmExist", qyjbxx);
	}
	...
	/** @param 企业基本信息(t_qyjbxx) 分页查询  企业变更查询 目前印刷业专用*/
	public Page getListForPageQybgCx(Map map, int pageNo,int pageSize,String sort,String desc){
		// TODO: implement
		String sCol="";
		if(desc == null)
			desc = "";
		...
		map.put("pageSort", sCol);
		return queryForPage("getQybgCxList", map, pageNo,pageSize);
	}
}
