...
public class WscqyDaoImpl extends BaseDao implements IWscqyDao {
	...
	/** @param 未上传企业(t_wscqy) 分页查询 企业刷卡未上传*/
	public Page getSkcstjListForPage_New(Map map, int pageNo,int pageSize,String sort,String desc){
		...
		map.put("pageSort", sCol);
		return queryForPage("getSkcstjList_New", map, pageNo,pageSize);
	}
	/** @param 未上传企业(t_wscqy) 分页查询 企业刷卡未上传明细*/
	public Page getSkcstjListForPage_Newxx(Map map, int pageNo,int pageSize,String sort,String desc){
		String sCol="tjrq desc";
		map.put("pageSort", sCol);
		return queryForPage("getSkcstjList_Newxx", map, pageNo,pageSize);
	}
	...
	public Page getlistsktj_qyzs(Map map, int pageNo,int pageSize,String sort,String desc){
	    ...
	    else sCol = "tjrq desc,qybm";

	    map.put("pageSort", sCol);
	    return queryForPage("getlistsktjmx", map, pageNo, pageSize);
	}
}
