...
public interface IQyjbxxDao {
	 ...
	 * @param qyjbxx(qyid,zjbh)
	 */
	Qyjbxx isQyjbxxqybmExist(Qyjbxx qyjbxx);
	...
	/** @param 企业基本信息(t_qyjbxx) 分页查询  企业变更查询 印刷业专用*/
	Page getListForPageQybgCx(Map map, int pageNo,int pageSize,String sort,String desc);
}
