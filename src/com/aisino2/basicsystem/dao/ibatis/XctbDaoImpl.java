...
public class XctbDaoImpl extends BaseDao implements IXctbDao {
	...
	public Page getListGajg(Map map, int pageNo,int pageSize,String sort,String desc){
		...
		map.put("pageSort", sCol);
		return queryForPage("getXctbListGajg", map, pageNo,pageSize);
	}
	...
	public Page getListForPageNbdw(Map map, int pageNo,int pageSize,String sort,String desc){
		...
		map.put("pageSort", sCol);
		return queryForPage("getXctbListNbdw", map, pageNo,pageSize);
	}
	...
	public List getXctbListForBm(Map map){
		return queryForList("getXctbListForBm", map);
	}
	
	/** 企业端弹出提示框提示未回复的通知通报条数 */
	public int getNoReplyNum(Map map){
	    return ((Integer)queryForObject("getNoReplyNum",map)).intValue();
	}
	...
	public Page getListWhf(Map map, int pageNo,int pageSize,String sort,String desc){
		...
		map.put("pageSort", sCol);
		return queryForPage("getXctbListWhf", map, pageNo,pageSize);
	}
}
