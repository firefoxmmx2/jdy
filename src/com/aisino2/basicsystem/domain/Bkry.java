...
public class Bkry extends BaseObject {
	...
	/** @ --布控操作时间字符串--bkczsjstr--String---*/
	private String bkczsjstr;
	...
	/** @ --布控到期时间字符串--bkdqsjstr--String--- */
	private String bkdqsjstr;
	...
	/** @ 布控操作时间字符串(bkczsjstr)*/
	public String getBkczsjstr() {
		return bkczsjstr;
	}

	public void setBkczsjstr(String bkczsjstr) {
		this.bkczsjstr = bkczsjstr;
	}

	/** @ 布控到期时间字符串(bkdqsjstr)*/
	public String getBkdqsjstr() {
		return bkdqsjstr;
	}

	public void setBkdqsjstr(String bkdqsjstr) {
		this.bkdqsjstr = bkdqsjstr;
	}
