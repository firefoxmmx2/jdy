...
public class Sjbdqxxkz extends BaseObject {
	...
	/** @ --手机被盗抢信息快照ID--sjbdqxxkzid--Integer--10-- */
	private Integer sjbdqxxkzid;
	...
	public Integer getSjbdqxxkzid() {
		return sjbdqxxkzid;
	}

	public void setSjbdqxxkzid(Integer sjbdqxxkzid) {
		this.sjbdqxxkzid = sjbdqxxkzid;
	}
