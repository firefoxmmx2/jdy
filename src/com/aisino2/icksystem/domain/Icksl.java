...
public class Icksl extends BaseObject {
	...
	private String isIckzxsjNull;//ick注销时间是否为空


	public String getIsIckzxsjNull() {
		return isIckzxsjNull;
	}

	public void setIsIckzxsjNull(String isIckzxsjNull) {
		this.isIckzxsjNull = isIckzxsjNull;
	}
