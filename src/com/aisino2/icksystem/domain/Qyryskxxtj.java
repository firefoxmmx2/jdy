...
public class Qyryskxxtj extends BaseObject {

	/** @param 企业人员刷卡信息统计明细(t_qyryskxxtj) */

	/** @ --刷卡ID2--skid--Integer--10-- */
	private Integer skid;

	/** @ --刷卡ID--skid2--Integer--10-- */
	private Integer skid2;
	...
	/** @ 刷卡ID(skid2) */
	public Integer getSkid2() {
		return skid2;
	}

	public void setSkid2(Integer skid2) {
		this.skid2 = skid2;
	}
	...
	public String getCsOrryFlag() {
		return csOrryFlag;
	}

	public void setCsOrryFlag(String csOrryFlag) {
		this.csOrryFlag = csOrryFlag;
	}
