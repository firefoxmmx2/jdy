...
public class IckslDaoImpl extends BaseDao implements IIckslDao {
	...
	public Icksl getIckslmax(Icksl icksl){
		// TODO: implement
		return (Icksl)queryForObject("getIckslmax", icksl);
	}
	...
	/** @param 查询生成的kh是否存在  */
	public Icksl getIckslkhExist(Icksl icksl)
	{
		return (Icksl)queryForObject("getIckslkhExist", icksl);
	}
	...
	public Page getIckNJList(Map map, int pageNo,int pageSize,String sort,String desc)
	{
		...
		map.put("pageSort", sCol);
		return queryForPage("getIckNJList", map, pageNo,pageSize);
	}
	/** @param IC卡受理(t_icksl) 修改 */
	public int updateIckslNJ(Icksl icksl){
		// TODO: implement
		return update("updateIckslNJ", icksl);
	}

	public Icksl getRyAndIckslCjd(Icksl icksl) throws Exception {
		// TODO Auto-generated method stub
		return (Icksl)queryForObject("getIckslAndRy", icksl);
	}
}
