...
public interface IIckslService {
	...
	/** @param 根据ryid  IC卡受理(t_icksl) 查询单条ickslid */
	Icksl getIckslmax(Icksl icksl); 
	...
	Page getIckNJList(Map map, int pageNo,int pageSize,String sort,String desc);
	
	/**
	 * 年检--更新企业人员信息和ic卡
	 */
	boolean updateIckNj(Icksl icksl,Qyryxx qyryxx)throws Exception;

	/** 查询单条人员和ic卡信息，采集点*/
	Icksl getRyAndIckslCjd(Icksl icksl) throws Exception;
}
