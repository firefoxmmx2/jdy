...
//    static ApplicationContext context =  new ClassPathXmlApplicationContext(DEFAULT_CONTEXT_FILE);   
  ...
  //字典
	...
	public static List getCacheDictitem(Dict_item dict_item){
		...
		/*if(dict_item != null && dict_item.getDict_code() != null && !"".equals(dict_item.getDict_code())){
		    lResultDictitem = dict_itemService.getListDict_item(dict_item);
		}*/
		...
		for (int i=0;i<lResultDictitem.size();i++){
			...
			if ( dict_item.getDict_code()!=null && !dict_item.getDict_code().equals("") && dict_itemReturn.getDict_code().equals(dict_item.getDict_code())){
				...
				if (dict_item.getDict_code()!=null && !dict_item.getDict_code().equals("") 
						 && (("").equals(dict_item.getItem_allpin())||dict_item.getItem_allpin()==null)
						 && (("").equals(dict_item.getItem_simplepin())||dict_item.getItem_simplepin()==null)
						 && dict_item.getSuper_item_id()==null
						 && (("").equals(dict_item.getFact_value())||dict_item.getFact_value()==null)
						 && (("").equals(dict_item.getDisplay_name())||dict_item.getDisplay_name()==null)
						 && (("").equals(dict_item.getAppend_value())||dict_item.getAppend_value()==null)
						 ){
				...
				if(iFlag==0
					&&dict_item.getItem_allpin()!=null&&!"".equals(dict_item.getItem_allpin())
					&&dict_item.getItem_simplepin()!=null&&!"".equals(dict_item.getItem_simplepin())
					&&dict_item.getFact_value()!=null&&!"".equals(dict_item.getFact_value())
					&&dict_item.getDisplay_name()!=null&&!"".equals(dict_item.getDisplay_name())){
	...
	//根据机构id取code
	public static Department getCacheDepartcode(Department department){
		IDepartmentService departmentService=(IDepartmentService)context.getBean("departmentService");
		List lResultDepartment=departmentService.getListDepartment(null,"1");
		List lDepartment=new ArrayList();
		...
		for (int i=0;i<lResultDepartment.size();i++){
			departmentReturn=(Department)lResultDepartment.get(i);
			if(department.getDepartid().equals(departmentReturn.getDepartid()))
			{
