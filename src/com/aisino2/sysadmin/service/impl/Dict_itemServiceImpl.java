...
public class Dict_itemServiceImpl extends BaseService implements IDict_itemService {
	...
	/** 流动人口新界面的户籍弹出层列表查询语句*/
	public Page getLdrkHj_ForPage(Map map, int pageNo,int pageSize,String sort,String desc){
		return dict_itemDao.getLdrkHj_ForPage(map, pageNo, pageSize, sort, desc);
	}
