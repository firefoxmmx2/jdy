...
public class UserServiceImpl extends BaseService implements IUserService {
	...
	public boolean updateUserDepartid(User user){
		return userDao.updateUserDepartid(user)>0;
	}
	...
	/** @param 流管端用户(t_user) 分页查询 */
	public Page getLgdListForPage(Map map, int pageNo,int pageSize,String sort,String desc){
		// TODO: implement
		return userDao.getLgdListForPage(map,pageNo,pageSize,sort,desc);
	}
	...
	//（公安CA）
	public User checkGaCAUser(User user) {
		// TODO Auto-generated method stub
		 return userDao.checkGaCAUser(user);
	}
	...
	*/
	...
	public User getQybmByCyrybh(User user)
	{
		...
		if(usertype.indexOf("202")>-1||usertype.indexOf("203")>-1){
			sqlStmt.append(" select b.qybm as ssdwbm,b.qymc as ssdwmc");
			sqlStmt.append(" from t_qyjbxx b where b.qybm='");
			sqlStmt.append(user.getUseraccount().substring(0,13));
			sqlStmt.append("' ");
		}else{
			...
			/*else if(usertype.indexOf("42")>-1)//机修员工
			{
				qybmzdm = "jxqybm";
				qybmzmc = "jxqymc";
				rybm= "t_jxcyryxx";
			...
			if((usertype.indexOf("32")>-1&&!"old".equals(ddyversion))
					||usertype.indexOf("42")>-1
					||usertype.indexOf("52")>-1
					||usertype.indexOf("62")>-1
					||usertype.indexOf("72")>-1
					||usertype.indexOf("82")>-1
					||usertype.indexOf("92")>-1
					||usertype.indexOf("102")>-1
					||usertype.indexOf("152")>-1
					||usertype.indexOf("162")>-1
					||usertype.indexOf("212")>-1
					||usertype.indexOf("222")>-1)
	 ...
	 *  通过企业编码取的企业营业状态和装机状态
	 */
	public User getQyztByQybm(String qybm){
		return userDao.getQyztByQybm(qybm);
	}
