...
public interface IUserService {
	...
	/** @param 用户(t_user) 修改departid */
	boolean updateUserDepartid(User user);
	...
	Page getLgdListForPage(Map map, int pageNo,int pageSize,String sort,String desc);
	 ...
	 *  通过企业编码取的企业营业状态和装机状态
	 */
	User getQyztByQybm(String qybm);
