...
public class DepartmentDaoImpl extends BaseDao implements IDepartmentDao {
	...
	public Department getDepartment_ty(String sqlStmt){
		// TODO: implement
		Department department=new Department();
		department.setDepartcode(sqlStmt);
		return (Department)queryForObject("getDepartment_ty", department);
	}
	...
	public List getAllChild(Department depart){
		return queryForList("getAllChild", depart);
	}
	...
	public List getAllDeptList(Department department){
		// TODO: implement
		return queryForList("getAllDeptList", department);
	}
	
	/** @param 特性许可证管辖单位查询    多条查询 */
	public List getThGwdwList(Department department) {
	    return queryForList("getThGwdwlist", department);	    
	}
   //获取本级以及本级以下部门信息
	public List getSelfandChild(Department depart){
		return queryForList("getSelfandChild",depart);
	}
}
