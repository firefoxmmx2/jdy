...
public class UserDaoImpl extends BaseDao implements IUserDao {
	...
	public int updateUserDepartid(User user){
		return update("updateUserDepartid",user);
	}
	...
	public Page getLgdListForPage(Map map, int pageNo,int pageSize,String sort,String desc){
		...
		map.put("pageSort", sCol);
		return queryForPage("getUserListforPage", map, pageNo,pageSize);
	}
	...
	public User checkGaCAUser(User user) {
		// TODO Auto-generated method stub
		   Object obj = queryForObject("checkGaCAUser", user);
		    return (obj == null) ? null : (User) obj;
	}
	...
	public User getQyztByQybm(String qybm){
		User user = new User();
		user.setSsdwbm(qybm);
		return user= (User)queryForObject("getQyztByQybm", user);
	}
