...
var itemSelect = 0;
 ...
 jfgztree=new dhtmlXTreeObject("dictItem_treeDropDown","100%","100%",0);
  ...
  jfgztree.setXMLAutoLoading("<c:out value="${pageContext.request.contextPath}"/>/jfgltree/jfgzTree_jfgz.action?treepar="+gdictCode+"&jfgzid="+gjfgzid);
  //tree.loadXML("<c:out value="${pageContext.request.contextPath}"/>/privisys/department.do?method=tree&id=0");
  jfgztree.loadXML("<c:out value="${pageContext.request.contextPath}"/>/jfgltree/jfgzTree_jfgz.action?treepar="+gdictCode+"&jfgzid="+gjfgzid);
