...
function pageImageBack(json){
	...
	if(lIcksl.length>0){
		...
		for(var ryNum=0;ryNum<lIckslLength;ryNum++){
			...
			imageTable += "<tr><td><a id=' href='#' onclick='Xsdtp("+ryid+");' ><img id='img"+ryid+"' src='icksystem/queryTp_icksl.action?ryId="+ryid+"' width='140' height='160' /></a></td></tr>";
...
//显示大图片方法
 function Xsdtp(id){
 	dataid=id;
 	setWidth("Bigimage","800");
 	setUrl("Bigimage","basic/icksystem/Tpfd.jsp");
	bindDocument("Bigimage");
 }
...
<div>-->
<div id="Bigimage" class="page-layout" src="#"
		style="display:none;top:80px; left:250px; width:800px;"></div>
