...
var xctbDaochuNum = 0;//是否可以导出Excle标志，0-无法导出，1-可以导出
var excelUrl="icksystem/getExcelCreateZkxxlb_icksl.action";
var searchLongUrl="icksystem/queryForExportZkxxlb_icksl.action";
...
function setPageList(pageno,url){	
	if (manVerify()){
		...
		var mygrid1 = $("#"+tableid).ingrid({ 
										...
										colWidths: ["10%","15.5%","5%","10%","11.5%","8%","4%","11%","6%","8%","9%"]									
									});				
		}
}	
	function manVerify(){
...
function setRyDetail(obj){
	...
	if(rylbValue == 0){
		...
		if($("#p_hylbdm").val() =="J"){
			...
			setUrl("cyryxx_detail","basic/publicsystem/WgcyryxxDetail-gzth.jsp");
		}
	}
}
				...
				<tr>
					<td colspan="7">
                      ...
                      <tr>
                        ...
                        <td ><a href="#" class="exceldcbutton" onClick="setExportExcel()" id="ickxxexcel">导出</a></td>
                      </tr>
                    </table>
					</td>
				</tr>
...
<div id="tabledata" style="width:100%;">
	<table id="table1" width="100%">
	  <thead>
	    <tr>       
	     	<th name="l_kh" datatype="string" sumflag="0">受理号</th>
	     	<th name="l_pch" datatype="string" sumflag="0">批次号</th>
	     	...
	     	<th name="l_slsj" datatype="string" sumflag="0">受理时间</th>
	     	<th name="l_cjdmc" datatype="string" sumflag="0">受理点</th>
	     	<th name="l_zkztmc" datatype="string" sumflag="0">状态</th>
