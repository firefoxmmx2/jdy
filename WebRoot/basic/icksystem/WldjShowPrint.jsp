...
<script type="text/javascript">
	$(document).ready(function() {
	    bc_bottonMoveRight(7,'打印');
		bc_bottonMoveRight(7,'导出');
...
<table width="100%" border="0" align="right" cellspacing="0" cellpadding="0">
    <tr height="25">
        <td><a href="#" class="submitbutton" onclick='wldjPrint();'>打印</a></td>
        <td width="5%"><a href="#" class="exceldcbutton" onClick="expExcel('printContent');">导出</a></td>    
    </tr>
</table>
</body>
