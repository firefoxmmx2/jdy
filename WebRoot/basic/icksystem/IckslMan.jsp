...
var stCJDFlag = '<%=stCJDFlag%>';
	var colWidths0 = ["21.5%","9%","12%","4.5%","17%","11%","11%","8%","0%","0%","0%","6%"];
	var colWidths1 = ["22%","10%","12%","5%","17%","12%","12%","10%","0%","0%","0%","0%"];
	var tableWidth;
	var hideCol0 = [8,9,10];
	var hideCol1 = [8,9,10,11];
	var hideCol;
...
function setCsDetail(obj){
	...
	if($('#p_hylbdm').val()=="N"){
	 	var qybm=$("#"+$(obj).attr("id")).find("td").eq(10).text();
