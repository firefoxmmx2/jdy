...
<script type="text/javascript">
	...
	$("#a_xb").val($("#a_xbdm").attr("title"));
		...
		if (!checkControlValue("a_tbbh","String",1,20,null,0,"通报编号"))
			return false;
		if (!checkControlValue("a_xm","String",1,60,null,1,"姓名"))
			return false;
	...
	function openfile(){
		imgToBase(ImgerToBase1,"pmtPho","a_fileload","2000");	
	}
...
<table width="100%" border="0">
	<tr>
		...
		<td width="28%" rowspan="10" valign="top">
			<table width="50%" border="0" align="center" cellpadding="8"
				cellspacing="0">
		    <input type="hidden" id="a_fileload" />
				<tr>
					<td align="center" valign="top">
						<img id ="pmtPho" width="150px" height="170px" src="images/pic.gif"/>					</td>
			  </tr>
                	<tr>
					<td align="center" valign="top">
