...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#m_cjfklbdm").selectBox({code:"dm_cjfklb"}); // 未抓获原因选择框
	...
	function cjhfVerify(){
		if (!checkControlValue("m_chjsj","Datetime",null,null,null,1,"出警时间"))
			return false;
		if (!checkControlValue("m_cjfzr","String",1,100,null,1,"反馈人"))
			return false;
		if (!checkControlValue("m_lxdh","String",1,30,null,0,"回复人联系电话"))
			return false;
		if(hylbdm1=="A"){
			if (!checkControlValue("m_fjh","String",1,30,null,0,"房间号"))
				return false;
			}
		...
		if($("#m_cjjgdm").attr("value")=="1"){ // 已抓获
			...
			if (!checkControlValue("m_cjfklbdm","Select",1,2,null,1,"未抓获原因"))
			return false;
		}
    ...
    <tr>
      <td><table width="100%" id="detail2" class="detail">
        ...
        <tr>
          ...
          <td class="reddistd1"> 反馈人 </td>
          <td class="detailtd2"><input type="text"    id="m_cjfzr" />
          </td>
          <td class="distd1"> 回复人联系电话 </td>
        ...
        <tr>
          ...
          <td class="detailtd2"><input type="text"    id="s_ssqymc" />
          	...
          	<td class="distd1" ><div id="fjhdiv" style="display:none" >房间号</div></td>
