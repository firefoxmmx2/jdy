...
<script type="text/javascript">
	...
	var xctbhfqkckDaochuNum = 0;//是否可以导出Excle标志，0-无法导出，1-可以导出
			...
			var mygrid1 = $("#"+tableid).ingrid({ 
				...
				changeHref:function(table){//若表格无数据，则点击导出不起作用
					if($(table).find("tr").length==0){
						xctbhfqkckDaochuNum = 0;
					}else{
						xctbhfqkckDaochuNum = 1;
					}	
				},
			    noSortColIndex:[4],
  ...
  function setXiangQing(id){
	...
	function searchLongBack(json){  
		...
		var bbmc="通知通告回复情况查看";
		//报表请求	
		setExcelLong("xctbhfqkckExcel",bbmc);	
	}
</script>
						...
						<td colspan="6">
							<table border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="25%">
										<a href="#" class="exceldcbutton" id='xctbhfqkckExcel' onclick='setExportExcel();'>导出</a>
									</td>
								</tr>
							</table>
						</td>
