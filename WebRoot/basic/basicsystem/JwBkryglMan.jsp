...
$(document).ready(function() {
	searchLongUrl="basicsystem/queryForExportJwCX_bkry.action";
	...
	excelUrl = "basicsystem/getExcelCreateJwCX_bkry.action";
...
function setPageList(pageno,url){	
	...
	function searchLongBack(json){   
			...
			//报表请求
				...
				setExcelLong("jwbkryglExcel",bbmc);	
	}
</script>
	<body>
							...
							<td class="pagetd">
								<table width="90" border="0" align="right" cellpadding="2"
									...
									<tr>
										...
										<td width="25%" >
											<a href="#" class="exceldcbutton" id='jwbkryglExcel' onclick='setExportExcel();'>导出</a>
										</td>
									</tr>
								</table>
							</td>
		...
		<div id="BkryData" style="width:100%;">
			<table id="BkryTable" width="100%">
				<thead>
					<tr>
						<th name="l_zwm" datatype="string" sumflag="0">
							中文名
						</th>
						<th name="l_ywm" datatype="string" sumflag="0">
							英文名
						</th>
						<th name="l_ywx" datatype="string" sumflag="0">
							英文姓
						</th>
						...
						<th name="l_gj" datatype="string" sumflag="0">
							国籍
						</th>
