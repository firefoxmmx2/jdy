...
<script type="text/javascript">
 ...
 //判断行业类型选择了没，如果没有选择，需要先选择
  ...
  if($("#a_hylbdm").attr("value") == "J"){  //娱乐业
		...
		getLg_item_liandong("a_qymc","a_qybm","1");
...
//管辖单位所筛选框
	 $("#a_ssdwmc").click(function(){
		...
		getGxdwTree("a_ssdwmc","a_ssdwbm",null,null,null,null,null,null);
	});
	 $("#a_ladw").click(function(){
		//getGxdwTree("a_ladw","a_ladwbm","1");
		getGxdwTree("a_ladw","a_ladwbm",null,null,null,null,null,null);
	});
