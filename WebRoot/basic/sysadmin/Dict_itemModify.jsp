...
<script type="text/javascript">
	...
	function modifyVerify(){
		if (!checkControlValue("m_display_name","String",1,100,null,1,"显示值"))
			return false;
		if (!checkControlValue("m_fact_value","String",1,50,null,1,"实际值"))
			return false;
