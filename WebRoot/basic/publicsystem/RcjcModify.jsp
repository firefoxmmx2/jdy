...
<script type="text/javascript">
	...
	function updatediv (json) { 
		...
		$("#m_mjjczbh").attr("value",setNull(json.LRcjc[0].mjjczbh));
	...
	function modifyVerify(){
		...
		if (!checkControlValue("m_jcrxm","String",1,30,null,1,"检查人员姓名"))
			return false;
		
		if (!checkControlValue("m_jcrybh","String",1,20,null,1,"检查人警号"))
			return false;
		...
		if (!checkControlValue("m_mjjczbh","String",1,16,null,0,"民警检查证编号"))
			return false;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      <td align="left" id="titleBiaoti" class="title1">日常检查修改</td>
...
<table width="100%" id="modify">
	...
	<tr height="20">
		...
		<td class="detailtd"><input type="text" class="inputstyle" id="m_mjjczbh"/></td>
	</tr>
	<tr height="20">
		<td class="distd">检查事项</td>
		<td class="detailtd" colspan="3"><label>
		  <textarea id="m_jcsx" style="width:432;height:60"></textarea>
		</label></td>
	</tr>
	<tr height="20">
		<td class="red" valign="top">发现问题</td>
		<td class="detailtd" colspan="3"><label>
		  <textarea id="m_fxwt" style="width:432;height:60"></textarea>
		</label></td>
  	</tr>
    	<tr height="20">
		<td class="distd">处理结果</td>
		<td class="detailtd"  colspan="3"><textarea id="m_cljg" style="width:432;height:60" readonly class="readonly"></textarea></td>
	</tr>
    	<tr height="20">
    	<td class="distd">备注</td>
		<td class="detailtd"  colspan="3"><textarea id="m_bz" style="width:432;height:60"></textarea></td>
	</tr>
	<tr height="20">
