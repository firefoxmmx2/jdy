...
<script type="text/javascript">
	...
	*/
	function setSearchLong_rzwsc(){
		setParams("x_");
		jQuery.post("publicsystem/querylistrzwscExcelTemp_qyyyrztj.action",params,searchLongBack_rzwsc,"json");
	}
	//导出前对应setSearchLong()的回调方法  由于执行查询时候有延迟，故将导出放入回调函数

	function searchLongBack_rzwsc(json){  
		//报表标题
		var bbmc="营业日志统计未上传场所";
		//报表请求
	...
	function setExcelLong_rzwsc(excelid,bbmc){
		var surl="publicsystem/querylistrzwscExcel_qyyyrztj.action"+"?tabletitle="+tabletitle+"&bbmc="+bbmc;
		surl=encodeURI(surl);
		location.href = surl;
	}
</script>
