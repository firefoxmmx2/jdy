	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
		        ...
		        <td class="pagetd1"><input style="width:120px" type="text" class="inputstyle1" id="a_kdjyxkzbh"/></td>
...
<!-- 				<td class="pagetd1"><input style="width:120px" type="text" class="inputstyle1" id="a_thbajg" readonly/><input type="hidden" id="a_thbajgdm"/></td> -->
				...
				<td class="pagetd1"><input style="width:120px" type="text" class="inputstyle1" id="a_wstzqypzzsh" /></td>
			</tr>
            	<tr height="25">
