...
<script type="text/javascript">
	...
	$(document).ready(function() {
	    searchLongUrl="publicsystem/queryQyhcList_qyjbxx.action";  //超长参数后台Action对应url
	...
	$("#p_qymc").click(function(){ //服务场所筛选框
			...
			getTy_item_super("p_qymc","p_qybm","","kcyzx",$("#p_gxdwbm").attr("value"),"","","0",$('#p_allhylbdm').val());
	});
//导出Excel
    ...
    <td class="tdbg">
    	<table width="100%" border="0" cellspacing="0" cellpadding="2">
				<tr>
			       ...
			       <td width="23%" class="pagetd" colspan="2"><select type="select" id="p_allhylbdm"></select>
			       </td>
				...
				<tr>
				    ...
				    <td width="23%" class="pagetd" colspan="2"><input type="text" class="inputstyle" id="p_qymc" value="" readonly></td>
