		...
		var mygrid1 = $("#"+tableid).ingrid({
				...
				changeHref:function(table){
										...
										$(table).find("tr").each(function(){
													...
													var dbColIndex=colIndex+2;
													 if($(this).find("td:nth("+dbColIndex+")").text()>0){
																var temp=$(this).find("td:nth("+dbColIndex+")").text();
																var qybms=$(this).find("td:nth("+colIndex+")").text();
																
															$(this).find("td:nth("+dbColIndex+")").html("<a href='#' class='hyperlink' onClick=setScbcfxxQuery('"+temp1+"','"+qybms+"');>"+temp+"</a>");
															}
													});
