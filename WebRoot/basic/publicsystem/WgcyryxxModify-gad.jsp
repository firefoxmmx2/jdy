...
<table width="100%" cellpadding="2" cellspacing="0" id="add">
	...
	<tr id="qyryxxTr3" height="20">
		...
		<td id="ywm_data" class="detailtd"><input type="text" class="inputstyle" 	onkeyup="value=value.replace(/[^\a-zA-Z]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\a-zA-Z]/g,''))" id="m_ywm"/></td>
    </tr>
    <tr id="qyryxxTr4" height="20">
        <td id="ywx_title" class="red">英文姓</td>
		<td id="ywx_data" class="detailtd"><input type="text" class="inputstyle" 	onkeyup="value=value.replace(/[^\a-zA-Z]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\a-zA-Z]/g,''))" id="m_ywx"/></td>
