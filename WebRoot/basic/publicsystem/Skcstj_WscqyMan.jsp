...
<script type="text/javascript">
	...
	function qyjbxx_setList(pageno,url){	
		...
		if (url==null || url=="undefined"){
			url="publicsystem/querylistsktjwscqy_wscqy.action";
		}
		return url;
	}
	...
	*/
	function setSearchLong_rzwsc(){
		setParams("x_");
		jQuery.post("publicsystem/querylistsktjwscqyExcelTemp_wscqy.action",params,searchLongBack_rzwsc,"json");
	}
	...
	function setExcelLong_rzwsc(excelid,bbmc){
		var surl="publicsystem/querylistsktjwscqyExcel_wscqy.action"+"?tabletitle="+tabletitle+"&bbmc="+bbmc;
		surl=encodeURI(surl);
		location.href = surl;
	}
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      <td align="left" class="title1">未上传企业明细</td>
