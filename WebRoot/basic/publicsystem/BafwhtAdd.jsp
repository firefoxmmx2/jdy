...
<script type="text/javascript">
	...
	function bafwht_addVerify(){
		...
		if (!checkControlValue("a_qdrq","Date",null,null,null,1,"签订日期"))
			return false;
		if (!checkControlValue("a_htyxq","Float",0.5,99.5,1,1,"合同有效期"))
		    return false;
		if  (!checkIsInteger($("#a_htyxq").val()*12)){
		...
		intYear.setTime(intYear.setMonth(intYear.getMonth()+parseInt($("#a_htyxq").val()*12)));   
		...
		$("#a_jsrq").val(intYear.getFullYear()+'-'+strMonthjs+'-'+strDayjs);
