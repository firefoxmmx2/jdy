...
$(document).ready(function() {
	...
	searchLongUrl="publicsystem/querycxForExport_qyryxx.action";  //超长参数后台Action对应url
...
function setPageList(pageno,url){
	...
	if (manVerify()){
		...
		var mygrid1 = $("#"+tableid).ingrid({ 
										...
										hideColIndex: [7,10],
										colWidths: ["8%","12%","13%","5%","14%","15%","15%","0%","8%","10%","0%"]									
									});				
		}
}
//照片显示回调方法
...
<input type="hidden" id="p_scbz" value="0">
    ...
    <td valign="top" class="tdbg">
    	<table width="100%" border="0" cellspacing="0" cellpadding="2">
				<tr>
			      ...
			      <td width="23%" class="pagetd"><select name="cylb" id="p_allhylbdm">
				    </select></td>
