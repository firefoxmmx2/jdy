...
var hylbdm;
	$(document).ready(function() {
		...
		$("#a_jjlxr").append(setNull(json.LQyryxx[0].jjlxr));
		...
		initPage();	
		$("#ryImage").attr("src","publicsystem/queryTp_qyryxx.action?ryId="+json.LQyryxx[0].ryid+'&aa=<%=lo %>&cyryBh='+json.LQyryxx[0].cyrybh);
	}
