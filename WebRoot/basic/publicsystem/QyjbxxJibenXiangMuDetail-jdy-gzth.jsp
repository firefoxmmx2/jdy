...
<script type="text/javascript">
	...
	function qyjbxxXiangxi_updatediv(){
		...
		$('#wstzqypzzsh').append(setNull(jsonResultMes.LQyjbxx[0].wstzqypzzsh));
		$("#kdjyxkzbh").append(setNull(jsonResultMes.LQyjbxx[0].kdjyxkzbh));
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
				...
				<td class="distd1">快递经营许可证号</td>
		        <td class="detailtd2"width="132px"><span id="kdjyxkzbh"></span></td>
				<td class="distd1">外商投资企业批准证书号</td>
				<td class="detailtd2" width="132px"><span id="wstzqypzzsh"></span></td>
				<%--
