...
<script type="text/javascript">
	...
	function bgqkbalance_updatediv(json){ //对比信息 存放起来 待对比
		...
		addtotempList("dwfzrzjlb_",setNull(json.LQyjbxx[0].dwfzrzjlb));
		...
		addtotempList("wxywfl_",setNull(json.LQyjbxx[0].wxywfl));
		...
		if(setNull(json.LQyjbxx[0].hylbdm)=="E03"){//典当业专属
			//2011-05-06添加@hejing beijing
			
			addtotempList("frxb_",setNull(json.LQyjbxx[0].frxb));
			addtotempList("frxbdm_",setNull(json.LQyjbxx[0].frdm));
			addtotempList("jyfzrxb_",setNull(json.LQyjbxx[0].jyfzrxb));
			addtotempList("jyfzrxbdm_",setNull(json.LQyjbxx[0].jyfzrxbdm));
			addtotempList("jyxkzfzrq_",setNull(json.LQyjbxx[0].jyxkzfzrq));
			addtotempList("jyxkzyxqz_",setNull(json.LQyjbxx[0].jyxkzyxqz));
			addtotempList("thxkzfzrq_",setNull(json.LQyjbxx[0].thxkzfzrq));
			addtotempList("thxkzyxqz_",setNull(json.LQyjbxx[0].thxkzyxqz));
			addtotempList("yyzzfzrq_",setNull(json.LQyjbxx[0].yyzzfzrq));
			addtotempList("yyzzyxqz_",setNull(json.LQyjbxx[0].yyzzyxqz));
			addtotempList("xfshyjsbh_",setNull(json.LQyjbxx[0].xfshyjsbh));
			addtotempList("xfshyjsfzjg_",setNull(json.LQyjbxx[0].xfshyjsfzjg));
			addtotempList("xfshyjsfzjgdm_",setNull(json.LQyjbxx[0].xfshyjsfzjgdm));
			addtotempList("xfshyjsfzrq_",setNull(json.LQyjbxx[0].xfshyjsfzrq));
			//2011-05-06添加@hejing beijing
		}
		if(setNull(json.LQyjbxx[0].hylbdm)=="Z01"){ //中介机构业专属
		 	addtotempList("xfshyjsbh_",setNull(json.LQyjbxx[0].xfshyjsbh));	
		 	addtotempList("gdjycscqbh_",setNull(json.LQyjbxx[0].gdjycscqbh));	
		 	//addtotempList("dwfzrzjlb_",setNull(json.LQyjbxx[0].dwfzrzjlb));	
		}
		if(setNull(json.LQyjbxx[0].hylbdm)=="B"){//印章业专属
			//2011-05-16添加@hejing beijing
		...
		if(setNull(json.LQyjbxx[0].hylbdm)=="Y01"){//开锁业专属
			var sfjy=setNull(json.LQyjbxx[0].sfjy);
			if(sfjy=='1'){
				sfjy="是";
			}else{
				sfjy="否";
			}	
			 addtotempList("sfjy_",sfjy);
			addtotempList("ssxmc_",setNull(json.LQyjbxx[0].ssxmc));
			addtotempList("ssxdm_",setNull(json.LQyjbxx[0].ssxdm));
	...
	function loadSomeHyBack(json){
		...
		changeAndWriteRedFont("wxywfl_",setNull(json.LQyjbxx[0].wxywfl));
		//营业执照、经营许可证
		...
		//2011-05-06添加@hejing beijing
		if(setNull(json.LQyjbxx[0].hylbdm)=="E03"){ //典当业专属			
		changeAndWriteRedFont("frxb_",setNull(json.LQyjbxx[0].frxb));
		changeAndWriteRedFont("frxbdm_",setNull(json.LQyjbxx[0].frdm));
		changeAndWriteRedFont("jyfzrxb_",setNull(json.LQyjbxx[0].jyfzrxb));
		changeAndWriteRedFont("jyfzrxbdm_",setNull(json.LQyjbxx[0].jyfzrxbdm));
		changeAndWriteRedFont("jyxkzfzrq_",setNull(json.LQyjbxx[0].jyxkzfzrq));
		changeAndWriteRedFont("jyxkzyxqz_",setNull(json.LQyjbxx[0].jyxkzyxqz));
		changeAndWriteRedFont("thxkzfzrq_",setNull(json.LQyjbxx[0].thxkzfzrq));
		changeAndWriteRedFont("thxkzyxqz_",setNull(json.LQyjbxx[0].thxkzyxqz));
		changeAndWriteRedFont("yyzzfzrq_",setNull(json.LQyjbxx[0].yyzzfzrq));
		changeAndWriteRedFont("yyzzyxqz_",setNull(json.LQyjbxx[0].yyzzyxqz));
		changeAndWriteRedFont("xfshyjsbh_",setNull(json.LQyjbxx[0].xfshyjsbh));
		changeAndWriteRedFont("xfshyjsfzjg_",setNull(json.LQyjbxx[0].xfshyjsfzjg));
		changeAndWriteRedFont("xfshyjsfzjgdm_",setNull(json.LQyjbxx[0].xfshyjsfzjgdm));
		changeAndWriteRedFont("xfshyjsfzrq_",setNull(json.LQyjbxx[0].xfshyjsfzrq));	
		}
		if(setNull(json.LQyjbxx[0].hylbdm)=="Z01"){ //中介机构业专属
		 	changeAndWriteRedFont("xfshyjsbh_",setNull(json.LQyjbxx[0].xfshyjsbh));	
		 	changeAndWriteRedFont("gdjycscqbh_",setNull(json.LQyjbxx[0].gdjycscqbh));	
		 	changeAndWriteRedFont("dwfzrzjlb_",setNull(json.LQyjbxx[0].dwfzrzjlb));	
		}
		//2011-05-06添加@hejing beijing
		...
		if(setNull(json.LQyjbxx[0].hylbdm)=="Y01"){//开锁业专属
		 ...
		 changeAndWriteRedFont("sfjy_",sfjy);
		 changeAndWriteRedFont("ssxmc_",setNull(json.LQyjbxx[0].ssxmc));
		 changeAndWriteRedFont("ssxdm_",setNull(json.LQyjbxx[0].ssxdm));
	...
	function ksyInit(json){ //开锁业业初始
		changeLableTitle('gxdw_title','治安管辖机构');
		$("#someHyMes").load("basic/publicsystem/QyjbxxDetail-ls-ksy-gzth.jsp", {}, function(){
			loadSomeHyBack(json);
		});
	}
	function zjjgInit(json){ //汽车租赁
		changeLableTitle('gxdw_title','治安管辖机构');
		$("#someHyMes").load("basic/publicsystem/QyjbxxDetail-ls-zjjg-gzth.jsp", {}, function(){
			loadSomeHyBack(json);
		});
	}
	function ysyInit(json){ //印刷业
		changeLableTitle('gxdw_title','治安管辖机构');
		$("#someHyMes").load("basic/publicsystem/QyjbxxDetail-ls-ysy-gzth.jsp", {}, function(){
			loadSomeHyBack(json);
		});
	}
...
<!-- 企业信息开始 -->
<div style='overflow-y:scroll;overflow-x:hidden;height:550px;' class="scrollbarface">
<table width="98%" border="0" align="center"  cellpadding="0" cellspacing="0" height="520" id="qyxx" style="DISPLAY: block">
<tr>
<td valign="top">
