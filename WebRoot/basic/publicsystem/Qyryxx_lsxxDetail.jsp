...
<script type="text/javascript">
	...
	function updatediv (json) {
		...
		if(setNull(json.LQyryxx_lsxx[0].cyrylbdm)=='1'){
			...
			$("#wjry3").css("display","none");
			$("#wjry4").css("display","none");
			$("#zjhm_th").text("证件号码");
		}else{
			$("#wjry1").css("display","none");
			$("#wjry2").css("display","none");
		}
		...
		//境外人员的内容
		$("#ywx").append(setNull(json.LQyryxx_lsxx[0].ywx));
		$("#ywm").append(setNull(json.LQyryxx_lsxx[0].ywm));
...
<table width="100%" cellpadding="1" cellspacing="0" class="detail"
	id="detail">
	<tr>
	...
	<tr>
		...
		<td width="18%" class="detailtd2">
			<span id="xm"></span>
		</td>

		<td colspan="2" rowspan="9" align="center" valign="top"
			class="detailtd2">
