...
function jdwpxxadd(){ 
	...
	var jdwp_jdpxl=setNull($("#jdwp_jdpxl").val());//寄递品小类型
	var jdwp_jdmlxmc=setNull($("#jdwp_jdpxl option:selected").text());//寄递品大类型名称
...
<tr>
  <td>
	...
	<table width="100%" border="0" cellSpacing="0" cellPadding="0" >
	   <tr>
	       <td>
	           <jsp:include page="../../business/jdyzagl/jjrxx.jsp?pdbzw=ljjbxx"></jsp:include>
	       </td>
	       <td>
	       		&nbsp;
	       </td>
	       <td>
	            <jsp:include page="../../business/jdyzagl/sjrxx.jsp?pdbzw=ljjbxx"></jsp:include>
	       </td>
	   </tr>
	</table>
	<fieldset>
