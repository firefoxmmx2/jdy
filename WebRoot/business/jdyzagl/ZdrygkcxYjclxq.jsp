...
var fileData;
	...
	function modifyVerify(){
		if (!checkControlValue("m_ckyy","String",1,100,null,1,"处理原因"))
			return false;
		return true;
	}
	
	function setCkUpdate(){
		jConfirm("确定处理?","提示信息",function(r) {
				if(r==true){
					if (modifyVerify()){
						setParams("m_");
...
<tr>
  ...
  <tr height="20">
		<td class="red">处理原因</td>
		<td class="pagetd" colspan="3"><textarea style="width:404;height:20px" id="m_ckyy"></textarea></td>
	</tr>
	<tr align="center">
		<td colspan="3" align="right">&nbsp;</td>
		<td colspan="3" align="left"><a href="#" id="addbutton" hidefocus="true" class="submitbutton"
				align="right" title="预警处理" onclick='setCkUpdate();'>预警处理</a></td>
  </tr>
</table>
