        ...
        <td height="43" colspan="2" valign="top"><table width="96%" border="0" align="center" cellpadding="3" cellspacing="0">
          <tr>
            <td width="50%">
				<table>
		            <tr>
			            <td>当前用户：<span class="yhxx"><%=username %>(<%=gxdwmc%>)</span></td>
			            <td id="loginInfoTD">今日共有<span class="yhxx" id="loginNum"></span>个，全部共有<span class="yhxx" id="loginSum"></span>个用户登录</td>
		            </tr>
		         </table>
			</td>
