	function csxxtjInit(){
		...
		if (js_sdfjksdFlage == '1') { //省厅
			...
			gaveSelectInfo("dsjgdm",js_stCode); //赋值
			...
			gaveSelectInfo("dsjgdm",js_stCode); //赋值
			gaveSelectValue("dsjgdm",js_dsCode); //选值
			gaveSelectInfo("fxjdm",js_dsCode); //赋值
			...
			gaveSelectValue("dsjgdm",js_dsCode); //选值
			gaveSelectInfo("fxjdm",js_dsCode); //赋值
			gaveSelectValue("fxjdm",js_fjCode); //选值
			gaveSelectInfo("gxdwdm",js_fjCode); //赋值
