...
<jsp:include page="public/gsWebTools-DictUpdate.jsp">
	<jsp:param name="objid" value="DictUpdate" />
</jsp:include>
<jsp:include page="public/gsWebTools-DictControl.jsp">
	<jsp:param name="objid" value="DictControl" />
</jsp:include>
<%
    // user ID
