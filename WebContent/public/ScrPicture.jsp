		...
		<jsp:include page="gsWebTools-IDCard.jsp">
			<jsp:param name="objid" value="<%=idCardPic %>" />
             ...
             <table   width="64%" align="center"  border="0" cellspacing="0" cellpadding="4">
                  ...
                  <tr>
                    <td align="center" ><a href="#" onclick="DeviceOnescanOcr('<%=pic %>',<%=wi %>,<%=hi %>,<%=zh%>);addFun('<%=pic %>');return false;" class="submitlongbutton">一代证扫描</a></td>
                  </tr>
                  <%
                  	}
                  	if("false".equals(zh)){
                   ...
                   %>
                    <tr>
                    <td align="center" ><a href="#" onclick="Devicepassportscanocr('<%=pic %>',<%=wi %>,<%=hi %>,<%=zh%>);addFun('<%=pic %>');return false;" class="submitlongbutton">外国证件读取</a></td>
                  </tr>
                   <%
                   	}
                    %>
