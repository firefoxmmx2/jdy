...
<table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><img src="images/tztg.jpg" width="748" height="28" /></td>
      </tr>
      <tr>
        <td>
      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><img src="images/jqxx.jpg" width="748" height="28" /></td>
        </tr>
        <tr>
          <td>
               <table width="98%" border="0" cellpadding="1" cellspacing="0" bgcolor="#b9cfe4">
          <tr>
            <td>
