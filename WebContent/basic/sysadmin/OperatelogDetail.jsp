...
<script type="text/javascript">
	...
	function updatediv (json) { 
		...
		$("#operateip").append(setNull(json.LOperatelog[0].operateip));
		$("#operatemac").append(setNull(json.LOperatelog[0].operatemac));
...
<table width="100%"  cellpadding="4" cellspacing="0" class="detail" id="detail" >
	...
	<tr>
		<td class="distd1">用户IP</td>
		<td class="detailtd2"><span id="operateip"></span></td>
	</tr>
	<tr>
		<td class="distd1">用户MAC</td>
		<td class="detailtd2"><span id="operatemac"></span></td>
	</tr>
	<tr>
