...
<script type="text/javascript">
 ...
 //初始化
 pageUrl="basicsystem/querylistgadhf_xctb.action";
 divnid="XctbData";
 tableid="XctbTable";
 ...
 function setXiangQing(id){
		sFlag="false";
		dataid=id;
		setQuery_xctbgad(dataid,detailHtml,detailWidth); 
	} 
 function setQuery_xctbgad(id,url){
	  if(timeFlag){
	 	timeFlag = false;
		dataid=id;
...
<body>
    <input type="hidden" id="p_hf" value="Y"/>
