...
<div id="PrintDiv" class="scrollbarface"  style="overflow-y:auto;overflow-x:hidden;height:435">
<table width="100%" id="detail"  cellpadding="4" cellspacing="0"  class="tableborder" >
  ...
  <tr>
	...
	<tr>
 	...
 	<tr>
		<td class="distd1">通知通报<br>内&nbsp;容</td>
		<td class="detailtd2" colspan="5">
		<textarea id="fbnr" name="tzcs" theme="simple" style="font-size:12px;WIDTH:590;BORDER: #A3B4CD 1px solid;height:150px;" readonly="true">
        </textarea>
		</td>
	</tr>
    <tr>
...
<jsp:include page="../../public/prjWebControl-Print.jsp">
	<jsp:param name="objid" value="ctlPrint" />
</jsp:include>
<jsp:include page="../../public/prjWebControl-Margin.jsp">
	<jsp:param name="objid" value="ctlReg" />
</jsp:include>
