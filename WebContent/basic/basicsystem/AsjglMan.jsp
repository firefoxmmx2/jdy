...
function setPageList(pageno,url){	
	...
	function manVerify(){
		if(num!=0){
		//	if (!checkControlValue("p_hylbdmall","Select",1,100,null,1,"行业类别"))
			//	return false;
...
//企业（场所跟旅馆）详细查询
function getQyDetail(obj,hylx){
	
//	var hylx = $("#p_hylbdmall").attr("value");
	if("A"==hylx){//走旅馆的详情
		getLvguan(obj);
...
//	  bindDocument("ylcsjbxx_detail");
  ...
  function getpublicqy(obj){
      ...
      qyjbxx_requestType="detail";
	  CsHtml="basic/publicsystem/QyjbxxDetail-gzth.jsp";
	  setWidth("ylcsjbxx_detail","1000");
	  setUrl("ylcsjbxx_detail",CsHtml);
	  bindDocument("ylcsjbxx_detail");
  }	
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="2">
						<tr>
							...
							<td width="17%" class="pagetd">
								<select type="select" id="p_hylbdmall"  onchange="setHyxx();">
								</select>
							</td>
