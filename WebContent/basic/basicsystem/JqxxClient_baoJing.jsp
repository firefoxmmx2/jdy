...
<script type="text/javascript">
	$(document).ready(function(){
		...
		//20120314  bug2467修改报警客户端分行业类别查询警情信息 - 行业类别选择框检索行业类别 - 陈勇荣
...
<html>
	<body>
				...
				<td class="tdbg">
					<table width="100%" border="0" cellspacing="0" cellpadding="2">
						...
						<tr>
							...
							<td width="8%" class="pagedistd" style="display: none">
								行业类别
							</td>

							<td width="17%" class="pagetd" style="display: none">
								<select type="select" id="p_hylbdmall">
								</select>
							</td>

							<td colspan="7" class="pagedistd">
								&nbsp;
							</td>

							<td class="pagetd">
								<table width="60" border="0" align="right" cellpadding="2"
									cellspacing="0">
									<tr>
										<td width="25%">
		...
		<div id="bjxxb_detail" src="#" class="page-layout"
