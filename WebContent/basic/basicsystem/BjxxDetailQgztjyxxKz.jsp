...
<script type="text/javascript">
	...
	function qgztkzdiv (json) {             
		...
		var bdfs=json.LQgztjx_kz[0].bdfs;
		if(bdfs==null||bdfs==""){
			var jqztdm=json.LQgztjx_kz[0].jqztdm;
			if(jqztdm=='0-1'){
				bdfs="反比对报警";
			}else{
				bdfs="普通报警";
  ...
  <tr>
    ...
    <table width="100%" cellpadding="4" cellspacing="0" class="detail" id="detail">
      ...
      <tr>
       ...
       <td class="detailtd2"><span id="tbbh_zt"/></span></td>
      </tr>
      <tr>
	  ...
	  <tr>
	   ...
	   <tr>
	  	<td class="distd1">比对方式</td>
	    <td colspan="5" class="detailtd2" ><font color="red" ><span id="bdfs"/></span></font></td>
	  </tr>
    </table>
   	</td>
  </tr>
