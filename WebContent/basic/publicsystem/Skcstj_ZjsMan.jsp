...
<script type="text/javascript">
	...
	function qyjbxx_setList(pageno,url){	
		...
		if (url==null || url=="undefined"){
			url="publicsystem/querylistsktj_qyzs_wscqy.action";
		}
		return url;
	}
	...
	*/
	function setSearchLong_rzwsc(){
		setParams("x_");
		jQuery.post("publicsystem/querylistqyzsExcelTemp_wscqy.action",params,searchLongBack_rzwsc,"json");
	}
	...
	function setExcelLong_rzwsc(excelid,bbmc){
		var surl="publicsystem/querylistqyzsExcel_wscqy.action"+"?tabletitle="+tabletitle+"&bbmc="+bbmc;
		surl=encodeURI(surl);
		location.href = surl;
	}
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      <td align="left" class="title1">装机企业明细</td>
