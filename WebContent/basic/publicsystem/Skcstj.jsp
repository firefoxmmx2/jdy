...
$(document).ready(function() {
				...
				changeHref:function(table){
					...
					$(table).find("tr").each(function(){
						...
						if($(this).find("td:nth(5)").text()>0){
							...
							$(this).find("td:nth(5)").html("<a href='#' class='fontbutton' onClick=setSkscxxQuery('"+temp1+"');>"+temp+"</a>");
						}
					});
	...
	function setSkscxxQuery(id){
		 setXParmValue(id);
	     detailid="skcstj_detail";
		 setWidth(detailid,"1000");
	     $('#'+detailid).css('top','160');
		 var url="basic/publicsystem/skscCsxxMan.jsp";
	     setUrl(detailid,url);
	}
