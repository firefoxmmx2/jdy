...
$(document).ready(function() {
	...
	//*****导出Excel ***********************************
	tabletitle = "";  
	excelUrl="publicsystem/queryRcjcycyjxxListExcelTemp_publicrcjc.action";
	searchLongUrl="publicsystem/queryRcjcycyjxxListExcel_publicrcjc.action";  //超长参数后台Action对应url
	//*********导出至**************************************
	daggleDiv("rcjc_detail");
	rcjcycyj_loadPage(divnid);
		$("#p_hylbdmall").selectBoxinhylb({code:"dm_hylb"});
...
function setQuery(id){
	...
	bindDocument(detailid);
    		...
    		//导出Excel
function setRcjcycyjExportExcel(){
		if(manVerify()){
			var result = "<tr>";
		  	result += "<th name='l_jcjgmc'  datatype='String' sumflag='0'>检查机构</th>";
			result += "<th name='l_mjjczbh'  datatype='String' sumflag='0'>民警检查证编号</th>";
			result += "<th name='l_jcrq'  datatype='String' sumflag='0'>检查时间</th>";
	     	result += "<th name='l_jcrybh'  datatype='String' sumflag='0'>警号</th>";
	     	result += "<th name='l_jcrxm'  datatype='String' sumflag='0'>姓名</th>";
	     	result += "<th name='l_jcrzw'  datatype='String' sumflag='0'>职务</th>";
	        result += "</tr>";
	        tabletitle=result;
			setSearchLong();
			rcjcycyj_setPageList(1);
	...
	*/
	...
	function searchLongBack(json){  
		var bbmc="日常检查异常预警信息";
		setExcelLong("rcjcycyjExcel",bbmc);	
	}
    ...
    <td class="tdbg">
    	<table width="100%" border="0" cellspacing="0" cellpadding="2">
				<tr>
					...
					<td width="23%" class="pagetd"><select id="p_hylbdmall" class="inputstyle" value=""></select></td>
					...
					<td colspan="6">
	    		  	<table  border="0" align="right"  cellpadding="2"  cellspacing="0">
	    		    	<tr align="right">
	    		    	  ...
	    		    	  <td> <a href="#" class="exceldcbutton" onClick="setRcjcycyjExportExcel();" id="rcjcycyjExcel">导出</a></td>
	    		    	</tr>
