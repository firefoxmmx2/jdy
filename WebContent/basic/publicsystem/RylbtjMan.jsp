...
function removeOneRow(obj) {
	...
	function setDsQuery(id){
	 	...
	 	detailid="rylbtj_detail";
     	setWidth(detailid,"965");
     	$('#'+detailid).css('left','15').css('top','40');
	 	setUrl(detailid,"basic/publicsystem/RylbtjManx.jsp");
}
...
<div id="tabledata" class="scrollbarface"    style="overflow-y:scroll;height:500; border:1px #d8dbec solid;border-right:0px;">
	<table width="100%"  cellpadding="3" style="border-collapse:collapse;" cellspacing="0"  id="datatable" >
        <tr>
...
<div id="rylbtj_detail" class="page-layout" src="#" style="top:20px; left:160px; width:950px; display:none;"></div>
</body>
</html>