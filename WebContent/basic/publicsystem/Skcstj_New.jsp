...
var dataStore = new Ext.data.JsonStore({	
	id: 'dataStore',
	proxy: new Ext.data.HttpProxy({url:'<%=basePath%>publicsystem/querySkcstjList_New_wscqy.action'}),
...
function loadData() {
    if(manVerify()){
	    ...
	    if($("#t_dsjgbz").attr("value")=="1"){
	        $("#l_qyzs").before("<td width='50' id='l_dsjgmc' class='grid-header-bg1'>市局</td>");
...
function setXxQuery(id){
		 ...
		 var url="basic/publicsystem/Skcstj_Newxx.jsp";
		 setUrl(detailid,url);
}
...
<table width="1002"  cellpadding="3" style="border-collapse:collapse;" cellspacing="0"  id="datatable" >
        ...
        <td width="50" class="grid-header-bg1"  id="l_dsjgmc"  >市局</td>
        <td width="116" class="grid-header-bg1" id="l_fxjgmc"   >分县局公安机关</td>
        <td width="117" class="grid-header-bg1" id="l_gxdwmc"   >派出所</td>
        <td width="74" class="grid-header-bg1" id="l_qyzs">装机企业数</td>
        <td width="74" class="grid-header-bg1" id="l_scqys">上传企业数</td>
        <td width="74" class="grid-header-bg1" id="l_scl">上传率(%)</td>
        <td width="74" class="grid-header-bg1" id="l_wscqys">未上传场所数</td>      
      ...
      <tr entityclass="temp"  edittype="singletext">
        ...
        <td class="grid-header-hbbg" id="scqys"  property="scqys"></td>
        <td class="grid-header-hbbg" id="scl"  property="scl"></td>
        <td class="grid-header-hbbg" id="wscqys"  property="wscqys"></td>
